...
<head>
  ...
  <title>Gestion de calidad - SDM</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-danger sidebar sidebar-dark " id="accordionSidebar">
      ...
      <hr class="sidebar-divider">
      <li class="nav-item active">
        <a class="nav-link" href="monitoreos.php">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>MONITOREOS</span></a>
      </li>
      <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
        <a class="nav-link" href="crear_monitoreo.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>CREAR MONITOREO</span></a>
      </li><hr class="sidebar-divider d-none d-md-block">
                <li class="nav-item active">
        <a class="nav-link" href="monitoreos_supervisor.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>REFUTACIONES</span></a>
      </li>
      ...
      <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
        <a class="nav-link" href="dias_festivos.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span> DÍAS FESTIVOS</span></a>
      </li>
            <hr class="sidebar-divider d-none d-md-block">
                        <li class="nav-item active">
        <a class="nav-link" href="tipos_criterios.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>TIPOS DE CRITERIO</span></a>
      </li> <hr class="sidebar-divider d-none d-md-block">

            <li class="nav-item active">
        <a class="nav-link" href="tipos_monitoreos.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>TIPOS DE MONITOREO</span></a>
      </li>

                  <hr class="sidebar-divider d-none d-md-block">
            <li class="nav-item active">
        <a class="nav-link" href="tipos_canales.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>TIPOS DE CANALES</span></a>
      </li>
            <hr class="sidebar-divider d-none d-md-block">
                        <li class="nav-item active">
        <a class="nav-link" href="editar_detalle_item.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>EDITAR DETALLE ITEM</span></a>
      </li><hr class="sidebar-divider d-none d-md-block">
                        <li class="nav-item active">
        <a class="nav-link" href="asociar_pesos_criterios.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>ASIGNAR VALORES A CRITERIOS</span></a>
      </li><hr class="sidebar-divider d-none d-md-block">



            <li class="nav-item active">
        <a class="nav-link" href="asociar_valores.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>ASOCIAR VALORES A ITEMS</span></a>
      </li>
                        <hr class="sidebar-divider d-none d-md-block">
                  <li class="nav-item active">
        <a class="nav-link" href="nivel_tipificacion1.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>NIVEL DE TIPIFICACION 1</span></a>
      </li>

                  <hr class="sidebar-divider d-none d-md-block">
                  <li class="nav-item active">
        <a class="nav-link" href="niveles_tipificacion.php">
          <i class="fas fa-fw fa-pencil-alt"></i>
          <span>NIVEL DE TIPIFICACION 2</span></a>
      </li>
