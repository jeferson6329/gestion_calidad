...
$consulta = "SELECT m.id, m.id_llamada, m.nombre_asesor, tm.nombre AS tipo_monitoreo, c.nombre AS canal, 
    m.criterio1, m.criterio2, m.criterio3, m.criterio4, m.nota_final, m.fecha_llamada, m.fecha_monitoreo, m.descripcion, 
...
document.querySelectorAll('.btnVerDetalles').forEach(btn => {
    btn.addEventListener('click', function() {
        ...
        document.getElementById('detalle_criterio1').textContent = monitoreoActual.criterio1 ?? '';
        document.getElementById('detalle_criterio2').textContent = monitoreoActual.criterio2 ?? '';
        document.getElementById('detalle_criterio3').textContent = monitoreoActual.criterio3 ?? '';
        document.getElementById('detalle_criterio4').textContent = monitoreoActual.criterio4 ?? '';
